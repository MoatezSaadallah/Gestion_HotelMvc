		...
		<div id="page-wrapper">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Disponibilité des chambres</div>
					<!-- /.panel-heading -->
								...
								<tbody>
									<c:forEach items="${chambres }" var="chambre">
										<tr>
											...
											<td>
											<c:set var="etatreserve" scope="session" value="Reservé" />
											<c:url
											      ...
											      <c:set var = "etatoccupe" scope = "session" value = "Occupé"/>
											<c:url
